 ...
 *
 */
public class VisionAutomatedAimAndShootX extends Command
{
	...
	public VisionAutomatedAimAndShootX()
	{
	...
	{
		// Initialize the encoder based turn PID with the present encoder value
		// of zero
	...
	private void determine_robot_turn_angle(TargetInfo foundTarget)
	{
		...
		// Note: Both encoders have the same set point except the right is the
		// negative
		// of the left encoder
		// Note: Since the left encoder is being used, which is negative, then
		...
		if (foundTarget != null)
		{
			...
			if (pixelXOffset < 0)
			{
				// Make the offset positive and set the is positive variable to
				// -1
	...
	/**
	 * Method to determine when the robot chassis and shooter are aligned to the
	 * target
	 */
