...
public class AutonomousShootBoulder extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
		...
		addSequential(new ChassisDriveStraightDistance(400, 0.8));

		addSequential(new ChassisDriveTargetLIDAR(Robot.autoParameters.getLIDARDistance()));
    	
    	addParallel(new ShooterPositionControl(Robot.autoParameters.getShootAngle())); // move to correct hight before shooting
    	
      	addSequential(new ChassisTurnAngle(Robot.autoParameters.getTurnAngle(), 0.5));
      	addSequential(new ChassisDriveStraightDistance(Robot.autoParameters.getDriveStraightDistance(), 0.8));
      
      	
  		addSequential(new ChassisTurnToImageTarget(Robot.autoParameters.getTarget()));
      	...
      	else if (Robot.autoParameters.getShootAngle() == Constants.LOW_GOAL)
      	{
      		addSequential(new ShootBoulderInGoal(Robot.autoParameters.getShootAngle(), 1.0));
      	}
    } 
