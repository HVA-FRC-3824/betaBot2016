 ...
 *
 */
public class AutonomousLowBarShootHighGoal extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonomousLowBarShootHighGoal() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        addParallel(new ShooterPositionControl(65.0));
        addSequential(new ChassisTurnAngle(50.0, 0.0));
        
        addSequential(new ChassisDriveStraightDistance(100, 0.8));
        
        // Line up based on camera
//        addSequential(new ChassisTurnToImageTarget());
        
        // Shoot into the goal
        addSequential(new ShootBoulderInGoal(65.0, 1.0));
