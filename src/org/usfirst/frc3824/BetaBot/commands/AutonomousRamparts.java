...
public class AutonomousRamparts extends CommandGroup
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
		...
		// Drive over the Ramports
		// Raise the shooter
		addParallel(new ShooterPositionControl(10.0));
		
		// Allow time for the shooter to raise
		...
		// Allow time for the shooter to raise
		addSequential(new ShooterPositionControl(48.0));
		...
		addSequential(new ChassisDriveTargetLIDAR(340.0));
