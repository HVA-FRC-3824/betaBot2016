...
public class AutonomousRoughTerrian extends CommandGroup
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
		...
		addSequential(new ChassisDriveStraightDistance(305.0, 1.0));
		
		// Raise the shooter while turning towards the goal
		addParallel(new ShooterPositionControl(48.0));
		...
		addSequential(new ChassisTurnToImageTarget(Constants.TARGET_RIGHT));
...
//		addSequential(new Delay(2.0));
			...
			// Shoot into the goal
			addSequential(new ShootBoulderInGoal(48.0, 1.0));
