 ...
 */
public class HVA_PID implements PIDInterface, LiveWindowSendable
{
	...
	private double  m_F;                     // factor for feed forward term
	...
	{
		private HVA_PID m_controller;

		public PIDTask(HVA_PID controller)
		{
			if (controller == null)
			{
	 ...
	 *            The default is 50ms.
	 */
	public HVA_PID(double Kp, double Ki, double Kd, double Kf, PIDSource source, PIDOutput output, double period)
	{
		if (source == null)
		{
	 ...
	 *            The default is 50ms.
	 */
	public HVA_PID(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output, double period)
	{
	 ...
	 *            The PIDOutput object that is set to the output percentage
	 */
	public HVA_PID(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output)
	{
	 ...
	 *            The PIDOutput object that is set to the output percentage
	 */
	public HVA_PID(double Kp, double Ki, double Kd, double Kf, PIDSource source, PIDOutput output)
	{
