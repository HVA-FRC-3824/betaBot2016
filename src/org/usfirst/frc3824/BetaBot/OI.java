...
public class OI
{
    ...
    public JoystickButton climberInflateButton;
    public JoystickButton climberReleaseHookButton;
...
//    public JoystickButton DriverEnableShooterWheelsOff;
	...
	public OI()
	{
        ...
        climb = new JoystickButton(controllerJoystick, 12);
        climb.whileHeld(new ClimberClimb());
        climberReleaseHookButton = new JoystickButton(controllerJoystick, 7);
        climberReleaseHookButton.whenPressed(new ClimberReleaseHook());
        climberInflateButton = new JoystickButton(controllerJoystick, 6);
        climberInflateButton.whileHeld(new ClimberInflate());
