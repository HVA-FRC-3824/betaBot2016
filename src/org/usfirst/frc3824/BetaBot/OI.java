...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("ShooterSetWheelSpeed: In", new ShooterSetWheelSpeed(-1));
        SmartDashboard.putData("ShooterSetWheelSpeed: Out", new ShooterSetWheelSpeed(1));
        SmartDashboard.putData("ShooterSetWheelSpeed: Off", new ShooterSetWheelSpeed(0));
