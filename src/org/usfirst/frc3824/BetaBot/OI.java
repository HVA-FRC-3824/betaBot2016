...
public class OI
{
	...
	public OI()
	{
        ...
        button11.whenPressed(new ShooterElevationControl(-110.0));
        button10 = new JoystickButton(controllerJoystick, 10);
        button10.whenPressed(new ShooterElevationControl(-100.0));
        button9 = new JoystickButton(controllerJoystick, 9);
        button9.whenPressed(new ShooterElevationControl(-90.0));
        button8 = new JoystickButton(controllerJoystick, 8);
        button8.whenPressed(new ShooterElevationControl(-80.0));
        button7 = new JoystickButton(controllerJoystick, 7);
        button7.whenPressed(new ShooterElevationControl(-70.0));
        button5Down = new JoystickButton(controllerJoystick, 5);
        button5Down.whenPressed(new ShooterElevationControl(-50.0));
        button3Up = new JoystickButton(controllerJoystick, 3);
        button3Up.whenPressed(new ShooterElevationControl(-30.0));
