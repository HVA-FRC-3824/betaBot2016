...
public class OI
{
    ...
    public JoystickButton squidsRotateInButtonPressed;
    public JoystickButton squideRotoateInButtonReleased;
    public JoystickButton squidesRotateOutButtonPressed;
    public JoystickButton squidsRotateOutStopButtonReleased;
...
//    public JoystickButton DriverEnableShooterWheelsOff;
	...
	public OI()
	{
        ...
        squidsRotateOutStopButtonReleased = new JoystickButton(controllerJoystick, 9);
        squidsRotateOutStopButtonReleased.whenReleased(new SquidsRotateStop());
        squidesRotateOutButtonPressed = new JoystickButton(controllerJoystick, 9);
        squidesRotateOutButtonPressed.whenPressed(new SquidsRotateOut());
        squideRotoateInButtonReleased = new JoystickButton(controllerJoystick, 6);
        squideRotoateInButtonReleased.whenReleased(new SquidsRotateStop());
        squidsRotateInButtonPressed = new JoystickButton(controllerJoystick, 6);
        squidsRotateInButtonPressed.whenPressed(new SquidsRotateIn());
        ...
        SmartDashboard.putData("Climber Reset Hook", new ClimberResetHook());
