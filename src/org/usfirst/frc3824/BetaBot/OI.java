...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("Autonomous Low Bar", new AutonomousLowBar());
        SmartDashboard.putData("Autonomous Rough Terrian", new AutonomousRoughTerrian());
        SmartDashboard.putData("Autonomous Ramparts", new AutonomousRamparts());
        ...
        SmartDashboard.putData("ChassisTurnToImageTarget: CenterTarget", new ChassisTurnToImageTarget(1));
        SmartDashboard.putData("ChassisTurnToImageTarget: LeftTarget", new ChassisTurnToImageTarget(0));
        ...
        SmartDashboard.putData("VisionAimAndShoot", new VisionAimAndShoot());
        SmartDashboard.putData("Vision Shooter Height", new VisionShooterHeight());
