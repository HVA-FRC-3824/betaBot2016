...
public class BoulderIntake extends Subsystem
{
	...
	/**
	 * Method to set the boulder PID minimum and maximum output range
	 */
	...
	/**
	 * Method to set the boulder intake wheel speed
	 */
	...
	/**
	 * Method to return the right boulder intake pot voltage
	 */
	public double getIntakeRight()
	{
		return boudlerRightPosition.getVoltage();
	}
	
	/**
	 * Method to return the left boulder intake pot voltage
	 */
	public double getIntakeLeft()
	{
		return boulderLeftPosition.getVoltage();
	}
	...
	{
		// BEGIN AUTOGENERATED CODE, S;OURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
...
//        setDefaultCommand(new BoulderIntakeControl(-1, false));
	...
	/**
	 * Method to set the boulder intake pot PID set point (0 to 1)
	 */
